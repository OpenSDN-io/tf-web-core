...
//          INFO    : 3, //Green
        ...
        this.PATTERN_IP_ADDRESS  = /(^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$)|(^((fe80:)(([0-9a-f]{1,4}:){6,6}[0-9a-f]{1,4}))$)|(^((fe80:)(([0-9a-f]{1,4}:){1,6}:))$)|(^((fe80:)(([0-9a-f]{1,4}:){1,5}:[0-9a-f]{1,4}))$)|(^((fe80:)(([0-9a-f]{1,4}:){1,4}(:[0-9a-f]{1,4}){1,2}))$)|(^((fe80:)(([0-9a-f]{1,4}:){1,3}(:[0-9a-f]{1,4}){1,3}))$)|(^((fe80:)(([0-9a-f]{1,4}:){1,2}(:[0-9a-f]{1,4}){1,4}))$)|(^((fe80:)(([0-9a-f]{1,4}:){1}(:[0-9a-f]{1,4}){1,5}))$)|(^((fe80:)((:[0-9a-f]{1,4}){1,6}))$)/;
        ...
        this.QUERY_COLUMN_FORMATTER = {
            ...
            "COUNT(raw_rx_update_stats)": "number",

            "raw_rx_update_stats.total": "number",
            "SUM(raw_rx_update_stats.total)": "number",
            "MAX(raw_rx_update_stats.total)": "number",
            "MIN(raw_rx_update_stats.total)": "number",
            "AVG(raw_rx_update_stats.total)": "number",

            "raw_rx_update_stats.reach": "number",
            "SUM(raw_rx_update_stats.reach)": "number",
            "MAX(raw_rx_update_stats.reach)": "number",
            "MIN(raw_rx_update_stats.reach)": "number",
            "AVG(raw_rx_update_stats.reach)": "number",

            "raw_rx_update_stats.unreach": "number",
            "SUM(raw_rx_update_stats.unreach)": "number",
            "MAX(raw_rx_update_stats.unreach)": "number",
            "MIN(raw_rx_update_stats.unreach)": "number",
            "AVG(raw_rx_update_stats.unreach)": "number",

            "raw_rx_update_stats.end_of_rib": "number",
            "SUM(raw_rx_update_stats.end_of_rib)": "number",
            "MAX(raw_rx_update_stats.end_of_rib)": "number",
            "MIN(raw_rx_update_stats.end_of_rib)": "number",
            "AVG(raw_rx_update_stats.end_of_rib)": "number",
            ...
            "COUNT(raw_tx_update_stats)": "number",

            "raw_tx_update_stats.total": "number",
            "SUM(raw_tx_update_stats.total)": "number",
            "MAX(raw_tx_update_stats.total)": "number",
            "MIN(raw_tx_update_stats.total)": "number",
            "AVG(raw_tx_update_stats.total)": "number",

            "raw_tx_update_stats.reach": "number",
            "SUM(raw_tx_update_stats.reach)": "number",
            "MAX(raw_tx_update_stats.reach)": "number",
            "MIN(raw_tx_update_stats.reach)": "number",
            "AVG(raw_tx_update_stats.reach)": "number",

            "raw_tx_update_stats.unreach": "number",
            "SUM(raw_tx_update_stats.unreach)": "number",
            "MAX(raw_tx_update_stats.unreach)": "number",
            "MIN(raw_tx_update_stats.unreach)": "number",
            "AVG(raw_tx_update_stats.unreach)": "number",

            "raw_tx_update_stats.end_of_rib": "number",
            "SUM(raw_tx_update_stats.end_of_rib)": "number",
            "MAX(raw_tx_update_stats.end_of_rib)": "number",
            "MIN(raw_tx_update_stats.end_of_rib)": "number",
            "AVG(raw_tx_update_stats.end_of_rib)": "number",
        ...
        this.FIVE_NODE_COLOR = ['#045a8d', '#2b8cbe', '#74a9cf', '#a6bddb', '#d0d1e6'];
        ...
        /** Package Names **/
        this.ANALYTICS_QUERY_PACKAGES = ["ANALYTICSDB_ENABLE"];
        this.ANALYTICS_SNMP_PACKAGES = ["ANALYTICS_SNMP_ENABLE"];
        this.ANALYTICS_ALARM_PACKAGES = ["ANALYTICS_ALARM_ENABLE"];
    };
